$(function() {
    var data = [
        ...
        },
        {
            id: 2,
            title: 'Pain',
            body: 'If you are pained by an external thing, it is not this thing that disturbs you, but your own judgment about it. And it is in your power to wipe out this judgment now.',
        ...
        },
        {
            id: 4,
            title: 'Peace',
            body: 'If everyone demanded peace instead of another television set, then there would be peace',
            author: 'John Lennon'
        },
        {
            id: 5,
